...
//                                                        
	...
	int (*on_forced) (struct mdss_panel_data *pdata); //for preventing lcd black-out by touch hw reset
	int (*tp_ctrl) (struct mdss_panel_data *pdata, int enable); //for preventing display noise issue by touch ic pe operation
